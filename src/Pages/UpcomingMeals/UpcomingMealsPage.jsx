      ...
      >
        ...
        <div className="p-4 flex flex-col flex-1 justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-base-content/70 line-clamp-2">{meal.category}</p>
          </div>
          ...
          <Link
            to={`/upcoming-meal-details/${meal._id}`}
  ...
  return (
    <div className="mt-24">
      ...
      <div className="sticky top-16 lg:top-12 flex justify-center items-center gap-10 px-4 z-20 bg-base-100 pt-6 pb-4">
        <h1 className="text-3xl font-bold text-center lg:text-left">Upcoming Meals</h1>
        ...
        <main className="flex-1">
          ...
          {!isLoading && filterReady && (
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {meals.length === 0 ? (
                  <p className="text-center col-span-full">No upcoming meals found.</p>
                ) : (
